...
3. Успешная передача на каждом шаге происходит с вероятностью: $4p \cdot (1 - p) ^ 3$. Значит на первых трех шагах была неуспешная передача, а на 4 была успешная. Итого:
