...
1. Каков 48-разрядный Ethernet-адрес вашего компьютера?
   - ![alt text](image.png)
   - Ethernet-адрес 3c:52:a1:f9:6c:31
2. Какому устройству соответствует значение Ethernet-адреса?
   ...
   - Значение Ethernet-адреса соответствует сетевой карте в моем компьютере.
3. Каково значение исходного Ethernet-адреса? Какое устройство имеет такой Ethernet-адрес?
   - ![alt text](image-2.png)
   - Значение исходного Ethernet-адреса c4:ad:34:09:e1:49
   - Устройство Routerbo_09 (роутер)
4. Каков адрес назначения в этом Ethernet-кадре? Это Ethernet-адрес вашего компьютера?
   - ![alt text](image-3.png)
   - Aдрес назначения 3c:52:a1:f9:6c:31
   - Да, это Ethernet-адрес моего компьютера.
...
1. Каковы шестнадцатеричные значения исходного и конечного адресов в Ethernet-кадре,
   ...
   - Source c4:ad:34:09:e1:49
   - Destination 3c:52:a1:f9:6c:31
2. Содержится ли в ARP-сообщении IP-адрес отправителя?
   - ![alt text](image-5.png)
   - Да, содержится. 192.168.88.1
...
#### Решение
1. Вероятность, начать передачу на конкретном кванте для конкретного узла это $q = N \cdot p \cdot (1 - p) ^ {N - 1}$ (было в предыдущих лабораторных). Матожидание числа неудач до первого успеха для монетки это $\frac{1 - q}{q}$, где $q$ это вероятность успеха монетки. Тогда $x = \frac{1 - N \cdot p \cdot (1 - p) ^ {N - 1}}{N \cdot p \cdot (1 - p) ^ {N - 1}}$. Тогда эффективность протокола по формуле из условия это $\frac{k}{k + \frac{1 - N \cdot p \cdot (1 - p) ^ {N - 1}}{N \cdot p \cdot (1 - p) ^ {N - 1}} }$
2. Нужно максимизировать эффективность. Это равносильно минимизировать x. Посчитаем проивзодную, получим, что минимум в точке $p = \frac{1}{N}$
3. Посчитаем предел для x при $N \to \infty$, подставив $p = \frac{1}{N}$. Получим $\frac{1 - (1 - \frac{1}{N}) ^ {N - 1}}{(1 - \frac{1}{N}) ^ {N - 1}} = e - 1$. Тогда эффективность это $\frac{k}{k + e - 1}$
4. Заметим, что если растет L, то растет и k. А значит, что в пределе, $\frac{k}{k + e - 1}, k \to \infty = 1$.
