...
Код находится в файле rip/rip.py
...
Код находится в файле rip/rip2.py
...
Код в папке speed. Нужно выбрать опцию TCP на сервере и на клиенте.
...
Код в папке speed. Нужно выбрать опцию UDP на сервере и на клиенте.
